...
const UrineHCGNegative: React.FC = () => {
  const navigate = useNavigate();
  const [formData, setFormData] = useState<HCGData>({
    qcFileName: 'Urine hCG Negative Panel',
    qcLotNumber: '',
    qcExpirationDate: '',
    openDate: '',
    closedDate: '',
    ...
    analytes: [
      { name: 'Urine hCG Negative', abbreviation: 'hCG-Neg', expectedRange: 'Negative' },
      { name: 'hCG-Neg Internal Control', abbreviation: 'hCG-Neg Int Control', expectedRange: 'Valid' }
    ]
  });

  return (
    <div className="min-h-screen bg-slate-50">
      <NavBar name="Urine hCG Negative Panel" />
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-sm mb-8">
          ...
          <br />• For Internal Controls, options that faculty can enter are:
        </div>

        {/* Save Button */}
        <div className="flex justify-end">
          <button
            onClick={() => navigate('/faculty/urine-hcg-negative')}
...
export default UrineHCGNegative; 
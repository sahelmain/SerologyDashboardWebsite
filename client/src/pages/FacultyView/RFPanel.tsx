...
const RFPanel: React.FC = () => {
  const navigate = useNavigate();
  const [formData, setFormData] = useState<RFData>({
    qcFileName: 'RF',
    qcLotNumber: '',
    qcExpirationDate: '',
    openDate: '',
    ...
    analytes: [
      { name: 'Rheumatoid Factor Negative', abbreviation: 'RF-Neg', expectedRange: 'Negative', minLevel: '', maxLevel: '' },
      { name: 'Rheumatoid Factor Positive', abbreviation: 'RF-Pos', expectedRange: 'Positive', minLevel: '', maxLevel: '' },
    ]
  });
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-sm mb-8">
          ...
          <br />• <span className="font-bold">Minimum & Maximum QC Titer Range</span>, titers will be specified by reagent packet and enter by faculty. Examples of possible titers: 1:40, 1:80, 1:160, 1:320, & 1:640
        </div>

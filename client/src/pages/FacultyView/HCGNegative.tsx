...
const HCGNegative: React.FC = () => {
  const navigate = useNavigate();
  const [formData, setFormData] = useState<HCGData>({
    qcFileName: 'Serum hCG Negative Panel',
    qcLotNumber: '',
    qcExpirationDate: '',
    openDate: '',
    closedDate: '',
    ...
    analytes: [
      { name: 'Serum hCG Negative', abbreviation: 'hCG-Neg', expectedRange: 'Negative' },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <NavBar name="Serum hCG Negative Panel" />
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-end">
          <button
            onClick={() => navigate('/faculty/edit-qc/hcg')}

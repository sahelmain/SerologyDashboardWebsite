...
namespace Medical_Information.API.Migrations
{
    ...
    [Migration("20241206021042_AddQCNameToStudentReport")]
    partial class AddQCNameToStudentReport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Medical_Information.API.Models.Domain.AdminQCLot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FileDate = new DateTime(2024, 12, 5, 20, 10, 42, 147, DateTimeKind.Local).AddTicks(9221),
                            IsActive = false,
                            LotNumber = "888888888888",
                            OpenDate = new DateTime(2024, 12, 5, 20, 10, 42, 147, DateTimeKind.Local).AddTicks(9290),
                            QCName = "CMP Level I",
                            Qualitative = true
                        });
                });

...
{
    /// <inheritdoc />
    public partial class TypeandERAnalytes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "FileDate", "OpenDate", "Qualitative" },
                values: new object[] { new DateTime(2024, 12, 1, 20, 25, 32, 905, DateTimeKind.Local).AddTicks(6737), new DateTime(2024, 12, 1, 20, 25, 32, 905, DateTimeKind.Local).AddTicks(6769), true });

            migrationBuilder.UpdateData(
                table: "Analytes",
                keyColumn: "AnalyteID",
                keyValue: new Guid("46baac82-7390-4139-b4ae-9c284de63860"),
                columns: new[] { "ExpectedRange", "Type" },
                values: new object[] { null, "quantitative" });
